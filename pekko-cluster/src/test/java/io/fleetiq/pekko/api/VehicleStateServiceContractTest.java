    ...
    void validatesTelemetryAtTheServiceBoundary() {
        assertThrows(IllegalArgumentException.class, () ->
            new VehicleStateService.TelemetryUpdate(
                "tenant-a", "invalid", Instant.now(), 52.52, 13.405, 10));
        assertThrows(IllegalArgumentException.class, () ->
            new VehicleStateService.TelemetryUpdate(
                "tenant-a", "1HGCM82633A004352", Instant.now(), 91, 13.405, 10));
        assertThrows(IllegalArgumentException.class, () ->
            new VehicleStateService.TelemetryUpdate(
                "tenant-a", "1HGCM82633A004352", Instant.now(), 52.52, 13.405, -1));
        assertThrows(IllegalArgumentException.class, () ->
            new VehicleStateService.TelemetryUpdate(
                "", "1HGCM82633A004352", Instant.now(), 52.52, 13.405, 10));
    }
